...
// custom group for Aramis Management System
$config['groups']['ams_def_js'] = array(
	'js' => array(
		array('jquery-1.5.2.js', '', TRUE, TRUE),
		array('jquery-ui-1.8.11.custom.js', '', FALSE, FALSE),
		array('elastic.js', '', FALSE, FALSE),
		// array('jqGrid/i18n/grid.locale-en.js', '', FALSE, FALSE),
		// array('jqGrid/jquery.jqGrid.src.js', '', FALSE, FALSE),
		array('jqGrid-github/js/i18n/grid.locale-en.js', '', FALSE, FALSE),
		array('jqGrid-github/jquery.jqGrid.js', '', FALSE, FALSE),
		array('jquery.jeditable.mini.js', '', FALSE, FALSE),
		array('ams.js', '', FALSE, FALSE),
		array('ams_javascript.js', '', FALSE, FALSE),
		array('jquery.chained.mini.js', '', FALSE, FALSE),
	)
);
$config['groups']['ams_def_css'] = array(
	'css' => array(
		array('reset.css', 'screen', '', FALSE, FALSE),
		array('elastic.css', 'screen', '', FALSE, FALSE),
		array('Aristo/jquery-ui-1.8.7.custom.css', 'screen', '', FALSE, FALSE),
		// array('ui.jqgrid.css', 'screen', '', FALSE, FALSE),
		array('ui.jqgrid.4.1.1.css', 'screen', '', FALSE, FALSE),
		array('style.css', 'screen', '', FALSE, FALSE),
		array('nav.css', 'screen', '', FALSE, FALSE),
	)
);
$config['groups']['ams_def_both'] = array(
	'css' => array(
		array('reset.css', 'screen', '', FALSE, FALSE),
		array('elastic.css', 'screen', '', FALSE, FALSE),
		array('theme6/jquery-ui-1.8.11.custom.css', 'screen', '', FALSE, FALSE),
		array('style.css', 'screen', '', FALSE, FALSE),
	),
	'js' => array(
		array('jquery-1.5.2.js', '', FALSE, FALSE),
		array('jquery-ui-1.8.11.custom.js', '', FALSE, FALSE),
		array('elastic.js', '', FALSE, FALSE),
		array('jqGrid/i18n/grid.locale-en.js', '', FALSE, FALSE),
		array('jqGrid/jquery.jqGrid.src.js', '', FALSE, FALSE),
